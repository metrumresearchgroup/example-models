...
## Friberg-Karlsson model for neutropenia, one patient
rm(list = ls())
gc()
...
## Parameters for initial estimates
CLPrior = 10
QPrior = 15
VCPrior = 35
VPPrior = 105
...
## Generated with true values for the parameters
inits_true <- list(CL = 10, Q = 15, VC = 35, VP = 105, ka = 2.0,
                   mtt = 125, circ0 = 5, alpha = 3e-4, gamma = 0.17,
                   sigma = 1e-5, sigmaNeut = 1e-5)

with(inits_true, stan_rdump(ls(inits_true), file = paste0(modelName,".init.true.R")))

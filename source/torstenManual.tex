...
Torsten also provides linear interpolation given data points
...
Here $x_0$ can also be a vector. In this case, $y_0$ will be
the vector of the same size consisting of interpolated values.

Note that $x$ must be of strictly ascending order. When
$x_0$ is outside of the range of $x$, $y_0$ will take

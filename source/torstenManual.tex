...
User Manual \\ \ \\ \ \\ \ \\
\Large Torsten Version 0.84 \\ for Stan Version 2.17.1 \\ \ \\
\large February 2018}
\end{center}
...
assist. Please report issues, bugs, and feature requests on our GitHub
...
offer a version of Stan with Torsten built inside of it. Torsten 0.84
works with Stan 2.17.1. Torsten is built inside the Stan and Stan-math
...
integrator \cite{mixedSolver}. Torsten supports the mixed solver for

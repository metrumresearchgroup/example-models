...
The easiest way to install the CmdStan interface with Stan and Torsten is to run the bash file \texttt{setupTorsten.sh}\footnote{You can install the development version using \texttt{setupTorsten-dev.sh}.}. You can also do it manually on a terminal window:

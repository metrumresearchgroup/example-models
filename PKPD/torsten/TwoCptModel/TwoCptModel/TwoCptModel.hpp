...
namespace TwoCptModel_model_namespace {
...
class TwoCptModel_model : public prob_grad {
private:
    int nt;
    int nObs;
    vector<int> iObs;
    ...
    vector<double> tlag;
public:
    TwoCptModel_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "TwoCptModel_model_namespace::TwoCptModel_model";
        ...
        try {
            ...
            stan::math::assign(get_base1_lhs(biovar,1,"biovar",1), 1);
            current_statement_begin__ = 34;
            stan::math::assign(get_base1_lhs(biovar,2,"biovar",1), 1);
            current_statement_begin__ = 35;
            stan::math::assign(get_base1_lhs(biovar,3,"biovar",1), 1);
            current_statement_begin__ = 37;
            stan::math::assign(get_base1_lhs(tlag,1,"tlag",1), 0);
            current_statement_begin__ = 38;
            stan::math::assign(get_base1_lhs(tlag,2,"tlag",1), 0);
            current_statement_begin__ = 39;
            stan::math::assign(get_base1_lhs(tlag,3,"tlag",1), 0);
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(x, PKModelTwoCpt(time,amt,rate,ii,evid,cmt,addl,ss,theta,biovar,tlag));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "TwoCptModel_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef TwoCptModel_model_namespace::TwoCptModel_model stan_model;
